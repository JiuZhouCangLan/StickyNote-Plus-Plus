...
NGui::SettingUI::SettingUI(QWidget* parent /*= 0*/) : OriginUI::WindowNoBoder(parent), ui(new Ui::SettingUI())
{
...
NGui::ActionCmdStateListWidget::ActionCmdStateListWidget(QWidget* parent /*= 0*/) : QWidget(parent)
{
...
NGui::ActionCmdStateItem::ActionCmdStateItem(QWidget* parent /*= 0*/) : QWidget(parent)
{
